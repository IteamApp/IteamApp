...
if (isset($_GET['id'])){
    ...
    $result = mysql_query("SELECT *FROM userteamrelation where user_stunum=$id and user_team_relation!='3' ") or die(mysql_error());
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        while ($row = mysql_fetch_array($result)) {
            ...
            $result3 = mysql_query("SELECT * FROM usermessage where team_id=$teamid and user_stunum=$id ORDER BY message_time desc limit 1") or die(mysql_error());
